...
includeScript ('../Scripts/jquery-ui-1.10.3.custom.min.js');
includeScript ('../Scripts/jquery.fancyform.js');
includeScript ('../Scripts/js/jquery.placeholder.js');
includeScript ('../Scripts/js/regula.js');
